...
<style type="text/css">
	.mybody{
		background:url('img/girdGod.png');
	}
</style>
<body class="mybody">
	...
	<br>
	<a href="${pageContext.request.contextPath }/crop/queryStatus.action" style="padding:10px;"><span style="font-size:15px" class="glyphicon glyphicon-circle-arrow-left">返回</span></a>
	</nav>
